          ...
          <div className="flex-1 space-y-4 overflow-y-auto pr-2 z-10">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-lg p-5 hover:border-slate-700 transition-colors cursor-pointer">
              ...
              <div className="flex justify-end gap-3">
                <button className="py-2.5 px-4 bg-slate-800 hover:bg-slate-700 text-slate-300 text-sm font-medium rounded-lg transition-colors flex items-center gap-2">
                  <UserPlus className="w-4 h-4" /> Send Request
                </button>
                <button className="py-2.5 px-4 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 border border-blue-500/20 text-sm font-medium rounded-lg transition-colors flex items-center gap-2">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-lg p-5 hover:border-slate-700 transition-colors cursor-pointer opacity-70 hover:opacity-100">
              ...
              <div className="bg-slate-900 border border-slate-800 p-4 rounded-md mb-4 hidden">
                {/* Expanded view */}
              </div>
            </div>
          </div>
